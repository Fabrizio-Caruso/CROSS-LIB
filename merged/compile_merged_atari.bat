...
@REM -DDEBUG_CHARS
@REM
cl65.exe  -O -t atari  -DREDEFINED_CHARS -DFULL_GAME -DATARI_MODE1 -DSOUNDS --config %mypath%\..\cfg\atari_mode1_redefined_chars.cfg %mypath%\atari\atari_sounds.c %mypath%\atari\atari_input.c %mypath%\display_macros.c  %mypath%\enemy.c %mypath%\invincible_enemy.c %mypath%\level.c %mypath%\character.c %mypath%\text.c %mypath%\missile.c %mypath%\strategy.c %mypath%\input_macros.c %mypath%\main.c  -o %deliverables%\FULL_atari_mode1_redefined_chars.xex

@REM cl65.exe  -O -t atarixl -DREDEFINED_CHARS -DATARI_MODE1 -DFULL_GAME -DSOUNDS --start-addr 0x4000 %mypath%\atari\atari_sounds.c %mypath%\atari\atari_input.c %mypath%\display_macros.c %mypath%\enemy.c %mypath%\invincible_enemy.c %mypath%\level.c %mypath%\character.c %mypath%\text.c %mypath%\missile.c %mypath%\strategy.c %mypath%\input_macros.c %mypath%\main.c  -o %deliverables%\FULL_atariXL_mode1_sounds.xex

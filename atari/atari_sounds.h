...
#define _ATARI_SOUNDS
	...
	#include <peekpoke.h>
		...
		// POKE AUDCTL with zero and POKE 53775,3 	
	...
	{ \
		...
		for(i=300;i>0;--i) \
		{ \
			POKEY_WRITE.audc1 = i/20;\
		} \
	};
	
	//		POKEY_WRITE.audf2 = 0xA0; \
	//	POKEY_WRITE.audc2 = 0x2F; \
	...
	{ \
		...
		POKEY_WRITE.audctl = 0x00; \
		POKE(53775u,3); \
		POKEY_WRITE.audf1 = 0xD0; \
		POKEY_WRITE.audc1 = 0x0F; \
		for(i=150;i>0;--i) \
		{ \
			POKEY_WRITE.audc1 = i/10;\
		} \
	};	

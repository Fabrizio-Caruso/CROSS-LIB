...
#define LV_CROSS_OBJECTS \
    ...
    \
    \
    LV_CROSS_OFFSET+1+1+2,YSize-4-LV_CROSS_HEIGHT+1+2,XSize-2*(LV_CROSS_OFFSET)-8,1,WALL, \
    LV_CROSS_OFFSET+1+1+2,4+LV_CROSS_HEIGHT-1-2   ,XSize-2*(LV_CROSS_OFFSET)-8,1,WALL, \
	\

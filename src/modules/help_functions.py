...
def help_command(option_config, params):
    if len(params)<2:
        ...
        if params[1]=="assets":
            ...
            print("")
            print("<params>")
            print("If `standard` or nothing is passed to <params>, then it performs several standard tests, i.e., tests of type (1), (2), (3), (4), excluding (5).")
            print("If `all` is passed to <params>, then all tests are performed, i.e., tests of type (1), (2), (3), (4), (5).")
            print("")

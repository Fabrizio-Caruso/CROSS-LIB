...
@REM conio issues
@REM 
cl65.exe -O -t lynx  %mypath%\input_macros.c %mypath%\display_macros.c %mypath%\enemy.c %mypath%\invincible_enemy.c %mypath%\level.c %mypath%\character.c %mypath%\text.c %mypath%\missile.c %mypath%\strategy.c %mypath%\main.c  -o %deliverables%\lynx.bin


@REM conio issues + color unrecognized 
@REM cl65.exe -O -t supervision %mypath%\input_macros.c %mypath%\display_macros.c %mypath%\enemy.c %mypath%\invincible_enemy.c %mypath%\level.c %mypath%\character.c %mypath%\text.c %mypath%\missile.c %mypath%\strategy.c %mypath%\main.c  -o %deliverables%\supervision.bin

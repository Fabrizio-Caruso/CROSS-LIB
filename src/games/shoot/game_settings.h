...
#define DESTROYER_TRIGGER_DEAD_ROCKETS 3

#define DESTROYER_COUNT_DOWN 100
...
#define CONFUSE_COOL_DOWN (650/WAIT_SCALE)
...
#define FREEZE_COUNT_DOWN (40/EFFECT_SCALE)

#define INITIAL_FROZEN_COUNT_DOWN FROZEN_COUNT_DOWN

#define CONFUSE_COUNT_DOWN (150/EFFECT_SCALE)

#define INVINCIBILITY_COUNT_DOWN (88/EFFECT_SCALE)

#define INITIAL_INVINCIBILITY_COUNT_DOWN (INVINCIBILITY_COUNT_DOWN/4)

#define SUICIDE_COUNT_DOWN (250/EFFECT_SCALE)

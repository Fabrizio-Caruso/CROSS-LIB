...
#define _7X8_CHARS
	...
	#define _TILE_0_UDG     {0,0,6,3,3,1,0,0}
	#define _TILE_1_UDG     {12,6,51,25,31,15,1,3}
	#define _TILE_2_UDG     {0,0,0,64,126,127,64,0}
	#define _TILE_3_UDG     {96,48,24,12,127,127,12,24}
	...
	#define _TILE_8_UDG     {127,127,113,71,127,127,0,0}
	...
	#define _TILE_16_UDG    {0,92,16,8,4,28,0,0}
	...
	#define _TILE_17_UDG    {0,0,0,0,112,120,0,0}
	#define _TILE_18_UDG    {0,0,0,0,0,42,127,127}

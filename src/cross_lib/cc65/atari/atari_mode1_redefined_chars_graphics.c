...
#define _LEFT_HORIZONTAL_MISSILE 9
#define _RIGHT_HORIZONTAL_MISSILE 8	
#define _ROCKET 7
...
{		
	...
	DEAD_GHOST_IMAGE._imageData = GHOST_IMAGE._imageData;
		...
		LEFT_HORIZONTAL_MISSILE_IMAGE._color = _ATARI_MODE1_WHITE;
		RIGHT_HORIZONTAL_MISSILE_IMAGE._color = _ATARI_MODE1_WHITE;	

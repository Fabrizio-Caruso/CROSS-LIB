...
//     XSize-1-LV_HORIZ_WALLS_WIDTH/3-1,1+2*(YSize/5)-LV_HORIZ_WALLS_ADJUST-1,LV_HORIZ_WALLS_WIDTH/3,1,DIAMOND,_XL_GREEN
...
#define LV_HORIZ_WALLS_OBJECTS \
    ...
    \
	2,YSize-2,1,1,RING,_XL_WHITE, \
	XSize-3,2,1,1,FREEZE,_XL_CYAN, \
	\
	...
	2,YSize-1-2*(YSize/5)+LV_HORIZ_WALLS_ADJUST-1,LV_HORIZ_WALLS_WIDTH/3,1,DIAMOND,_XL_GREEN, \
	XSize-1-LV_HORIZ_WALLS_WIDTH/3-1,1+2*(YSize/5)-LV_HORIZ_WALLS_ADJUST-1,LV_HORIZ_WALLS_WIDTH/3,1,DIAMOND,_XL_GREEN

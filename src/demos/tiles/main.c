...
{        
    ...
    PRINT(COL_OFFSET,1,"01234567890");
    PRINT(COL_OFFSET,2,"abcdefghij-");
    PRINT(COL_OFFSET,3,"klmnopqrst-");
    PRINT(COL_OFFSET,4,"uvwxyz");
    PRINT(COL_OFFSET,5,"ABCDEFGHIJ-");
    PRINT(COL_OFFSET,6,"KLMNOPQRST-");
    PRINT(COL_OFFSET,7,"UVWXYZ");

...
#define _6X8_CHARS
	...
	#define _TILE_2_UDG     {12,26,12,31,44,12,10,10}
	#define _TILE_3_UDG     {12,22,12,62,13,12,20,20}

	#define _TILE_4_UDG     {33,30,33,51,33,45,33,30}
	#define _TILE_7_UDG     {30,33,51,33,33,18,18,12}
	#define _TILE_9_UDG     {0,32,31,40,56,32, 0, 0}

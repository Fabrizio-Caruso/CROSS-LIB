...
uint8_t last_move_dir;       /* 0 up,1 down,2 left,3 right */
short lives;
uint16_t score;
...
void update_game(void)
{
    ...
    if (_XL_FIRE(inp)) {
        /* build the three directions for the current heading */
        if (last_move_dir == 2) {          /* left */
            bdx[0] = -1; bdy[0] =  0;
            bdx[1] = -1; bdy[1] = -1;
            bdx[2] = -1; bdy[2] =  1;
        } else if (last_move_dir == 3) {   /* right */
            bdx[0] =  1; bdy[0] =  0;
            bdx[1] =  1; bdy[1] = -1;
            bdx[2] =  1; bdy[2] =  1;
        } else if (last_move_dir == 0) {   /* up */
            bdx[0] =  0; bdy[0] = -1;
            bdx[1] = -1; bdy[1] = -1;
            bdx[2] =  1; bdy[2] = -1;
        } else {                           /* down */

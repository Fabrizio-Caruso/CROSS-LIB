...
// LEVEL 2 - Rain
#define LV_5_OBJECTS LV_RAIN_OBJECTS
#define LV_5_OBJECTS_SIZE LV_RAIN_OBJECTS_SIZE
#define LV_5_SHURIKENS LV_RAIN_SHURIKENS
#define LV_5_SHURIKENS_SIZE LV_RAIN_SHURIKENS_SIZE
#define LV_5_WALLS LV_RAIN_WALLS 
#define LV_5_WALLS_SIZE LV_RAIN_WALLS_SIZE

#define LV_4_OBJECTS LV_H_BARRIERS_OBJECTS
#define LV_4_OBJECTS_SIZE LV_H_BARRIERS_OBJECTS_SIZE
#define LV_4_SHURIKENS LV_H_BARRIERS_SHURIKENS
#define LV_4_SHURIKENS_SIZE LV_H_BARRIERS_SHURIKENS_SIZE
#define LV_4_WALLS LV_H_BARRIERS_WALLS 
#define LV_4_WALLS_SIZE LV_H_BARRIERS_WALLS_SIZE
...
// LEVEL 5 - horiz wall
#define LV_3_OBJECTS LV_HORIZ_WALLS_OBJECTS
#define LV_3_OBJECTS_SIZE LV_HORIZ_WALLS_OBJECTS_SIZE
#define LV_3_SHURIKENS LV_HORIZ_WALLS_SHURIKENS
#define LV_3_SHURIKENS_SIZE LV_HORIZ_WALLS_SHURIKENS_SIZE
#define LV_3_WALLS LV_HORIZ_WALLS_WALLS 
#define LV_3_WALLS_SIZE LV_HORIZ_WALLS_WALLS_SIZE

// LEVEL 6 - squares
#define LV_7_OBJECTS LV_SQUARES_OBJECTS
#define LV_7_OBJECTS_SIZE LV_SQUARES_OBJECTS_SIZE
#define LV_7_SHURIKENS LV_SQUARES_SHURIKENS
#define LV_7_SHURIKENS_SIZE LV_SQUARES_SHURIKENS_SIZE
#define LV_7_WALLS LV_SQUARES_WALLS 
#define LV_7_WALLS_SIZE LV_SQUARES_WALLS_SIZE

// LEVEL 7 - many
#define LV_8_OBJECTS LV_MANY_OBJECTS
#define LV_8_OBJECTS_SIZE LV_MANY_OBJECTS_SIZE
#define LV_8_SHURIKENS LV_MANY_SHURIKENS
#define LV_8_SHURIKENS_SIZE LV_MANY_SHURIKENS_SIZE
#define LV_8_WALLS LV_MANY_WALLS 
#define LV_8_WALLS_SIZE LV_MANY_WALLS_SIZE

// LEVEL 8 - many
#define LV_6_OBJECTS LV_VERT_WALLS_OBJECTS
#define LV_6_OBJECTS_SIZE LV_VERT_WALLS_OBJECTS_SIZE
#define LV_6_SHURIKENS LV_VERT_WALLS_SHURIKENS
#define LV_6_SHURIKENS_SIZE LV_VERT_WALLS_SHURIKENS_SIZE
#define LV_6_WALLS LV_VERT_WALLS_WALLS 
#define LV_6_WALLS_SIZE LV_VERT_WALLS_WALLS_SIZE
...
const uint16_t objects_index[] = 
{
	...
	0,
	LV_0_OBJECTS_SIZE+LV_1_OBJECTS_SIZE+LV_2_OBJECTS_SIZE+LV_3_OBJECTS_SIZE+LV_4_OBJECTS_SIZE+LV_5_OBJECTS_SIZE+LV_6_OBJECTS_SIZE+LV_7_OBJECTS_SIZE+LV_8_OBJECTS_SIZE,
...
const uint8_t shurikens_index[] = 
{
	...
	LV_0_SHURIKENS_SIZE+LV_1_SHURIKENS_SIZE+LV_2_SHURIKENS_SIZE+LV_3_SHURIKENS_SIZE+LV_4_SHURIKENS_SIZE+LV_5_SHURIKENS_SIZE+LV_6_SHURIKENS_SIZE, // challenge (same as squares)
	...
	LV_0_SHURIKENS_SIZE+LV_1_SHURIKENS_SIZE+LV_2_SHURIKENS_SIZE+LV_3_SHURIKENS_SIZE+LV_4_SHURIKENS_SIZE+LV_5_SHURIKENS_SIZE+LV_6_SHURIKENS_SIZE+LV_7_SHURIKENS_SIZE, // challenge
    // 1+2*12+1+1,
...
const uint8_t walls_index[] =
{
	...
	LV_0_WALLS_SIZE+LV_1_WALLS_SIZE+LV_2_WALLS_SIZE+LV_3_WALLS_SIZE+LV_4_WALLS_SIZE+LV_5_WALLS_SIZE+LV_6_WALLS_SIZE+LV_7_WALLS_SIZE+LV_8_WALLS_SIZE, // challenge walls

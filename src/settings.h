...
#define SECOND_CONFUSE_COOL_DOWN 20000UL

#define ZOMBIE_COOL_DOWN (600/WAIT_SCALE)
#define SECOND_ZOMBIE_COOL_DOWN 20000UL

#define CHASE_COOL_DOWN (400/WAIT_SCALE)

#define EXTRA_POINTS_COOL_DOWN (1900UL/WAIT_SCALE)

#define INVINCIBILITY_COOL_DOWN (2500UL/WAIT_SCALE)

#define EXTRA_LIFE_COOL_DOWN (3000UL/WAIT_SCALE)
#define SECOND_EXTRA_POINTS_COOL_DOWN 65000UL

#define FROZEN_COUNT_DOWN (22UL/EFFECT_SCALE)

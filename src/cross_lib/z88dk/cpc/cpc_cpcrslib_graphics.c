...
{		
	...
	DEAD_GHOST_IMAGE._color = CPC_RED;
		...
		LEFT_HORIZONTAL_MISSILE_IMAGE._imageData = _LEFT_MISSILE;
		LEFT_HORIZONTAL_MISSILE_IMAGE._color = CPC_WHITE;
		RIGHT_HORIZONTAL_MISSILE_IMAGE._imageData = _RIGHT_MISSILE;
		RIGHT_HORIZONTAL_MISSILE_IMAGE._color = CPC_WHITE;	

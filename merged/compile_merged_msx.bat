...
@REM 
zcc +msx -create-app -vn  -DVPOKE -D__MSX__ -lndos -create-app -o %deliverables%\MINIMAL_msx_16k_experimental_MODE0.prg %mypath%\display_macros.c %mypath%\enemy.c %mypath%\invincible_enemy.c %mypath%\level.c %mypath%\character.c %mypath%\text.c %mypath%\missile.c %mypath%\strategy.c %mypath%\input_macros.c %mypath%\main.c
@REM 
@REM 

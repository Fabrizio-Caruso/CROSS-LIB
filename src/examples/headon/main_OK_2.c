...
void moveCars(uint8_t input)
{
    ...
    /* --- Player movement: turn clockwise on wall --- */
    ...
    /* --- AI direction: turn clockwise on wall --- */
    ...
    /* --- Collect dot at AI's new position --- */
    if (dots[newCx][newCy]) {
        dotVisible = 1;

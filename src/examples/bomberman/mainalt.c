...
/* ───────────────────────────────────────────── */
/*  Bomb explosion with chain reactions          */
/* ───────────────────────────────────────────── */
...
void explode_bomb(uint8_t bx, uint8_t by)
{
    ...
    /* Deactivate this bomb so it is not processed again */
    uint8_t i;
    for (i = 0; i < MAX_BOMBS; i++) {
    ...
    /* This bomb's centre becomes explosion */
    ...
    for (d = 0; d < 4 && !game_over; d++) {
        ...
        while (steps < BOMB_POWER &&
            ...
            /* Chain reaction: trigger another bomb in the blast path */
...
void process_bombs(void)
{
    ...
    /* Clear explosion tiles after they have been displayed */

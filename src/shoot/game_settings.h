...
#define FREEZE_COOL_DOWN (200/WAIT_SCALE)
...
#define ZOMBIE_COOL_DOWN (700/WAIT_SCALE)
...
#define FROZEN_COUNT_DOWN (40/EFFECT_SCALE)
...
#define SKULL_MIN_SLOWDOWN (4000/SKULL_MIN_SLOWDOWN_SCALE)

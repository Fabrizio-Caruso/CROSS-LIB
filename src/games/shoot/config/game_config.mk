...
PHC25_GAME_OPTS           ?= -DNO_INITIAL_SCREEN -DBOMB_DRAW_SKIP=3 -DWALL_DRAW_SKIP=7 -DGHOSTS_NUMBER=7 -DMAX_ARROWS_ON_SCREEN=6 -DNUMBER_OF_MISSILES=3 -DLESS_TEXT -DNO_BLINKING -DNO_HINTS -DSIMPLE_STRATEGY -DNO_TRANSICTION_ANIMATION
...
@REM 
@REM 
exomizer sfx basic %deliverables%\FULL_c64_redefined_characters.prg -o %deliverables%\FULL_c64_redefined_chars.prg
@REM 
@REM 
del %deliverables%\FULL_c64_redefined_characters.prg
@REM 
@REM 
cd %cc65path%\bin\
...
@REM cl65.exe  -t cbm610 %mypath%\display_macros.c  %mypath%\enemy.c %mypath%\invincible_enemy.c %mypath%\level.c %mypath%\character.c %mypath%\text.c %mypath%\missile.c %mypath%\strategy.c %mypath%\input_macros.c %mypath%\main.c  -o %deliverables%\cbm610.prg

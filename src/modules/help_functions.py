...
def help_command(option_config, params):
    if len(params)<2:
        ...
        if params[1]=="assets":
            ...
            print("If 'z88dk_extra' is passed to <params>, then it compiles a test program using Z88DK.")
            print("If 'z88dk_extra_alt' is passed to <params>, then it compiles a simplified test program using both Z88DK compilers.")
            print("If 'cc65_extra' is passed to <params>, then it compiles a test program using CC65.")
            print("If 'cmoc_extra' is passed to <params>, then it compiles a test program using CMOC.")
            print("If 'lcc1802_extra' is passed to <params>, then it compiles a test program using LCC1802.")

...
#define DISPLAY_TARGET_GEOMETRY_H
...
#if (defined(__TRS80__) && !defined(__EG2K__) && defined(__Z88DK_SPRITES)) \
	|| (defined(__OSBORNE1__) && defined(__Z88DK_SPRITES))
	#define EXTRA_TINY_Y
	#define EXTRA_TINY_X
#endif
#if defined(__TI82__) && defined(__Z88DK_SPRITES)
	#define EXTRA_TINY_X
#endif
	...
	#  if defined(__NCURSES__)
	...
	#elif defined(__KC__) && defined(__Z88DK_SPRITES)
	...
	#elif defined(__CBM610__) || defined(__PET__) || (defined(__C128__) && !defined(__Z88DK_SPRITES)) \
		...
		|| (defined(__OSCA__) && !defined(__Z88DK_SPRITES)) \
	...
	#elif (defined(__TS2068__) && defined(__Z88DK_SPRITES))
		#define YSize (192/__SPRITE_Y_STEP -Y_OFFSET)
	#elif (defined(__NC200__) && defined(__Z88DK_SPRITES))
		...
		#define YSize (10+1)
	#elif defined(__Z88__) || (defined(__PX8__) && !defined(__Z88DK_SPRITES)) \
		|| ((defined(__TI82__) || defined(__TI83__) || defined(__TI8X__) || defined(__TI85__) || defined(__TI86__)) && !defined(__Z88DK_SPRITES))
		#define YSize 8
	#elif defined(__G800__)
		#define YSize 7
	#elif ((defined(__TI82__) || defined(__TI83__) || defined(__TI8X__) || defined(__TI85__) || defined(__TI86__)) && defined(__Z88DK_SPRITES))
		#define YSize ((64/__SPRITE_Y_STEP)+1)
	#elif (defined(__VZ__) && defined(__Z88DK_SPRITES))
		#define YSize ((64/__SPRITE_Y_STEP)+1)
	#elif (defined(__PX8__) && defined(__Z88DK_SPRITES))
		#define YSize ((64/__SPRITE_Y_STEP)+1)		
	#elif (defined(__PX4__) && defined(__Z88DK_SPRITES))
		#define YSize ((64/__SPRITE_Y_STEP)+1)
	#elif (defined(__OSBORNE1__) && defined(__Z88DK_SPRITES))
		#define YSize ((48/__SPRITE_Y_STEP)-1)
	#elif defined(__TIKI100__)
		#define YSize ((256/__SPRITE_Y_STEP)-Y_OFFSET)
	#elif (defined(__NC100__) && defined(__Z88DK_SPRITES)) 
		#define YSize ((64/__SPRITE_Y_STEP)+1)
	...
	#elif defined(__ATTACHE__) && defined(__Z88DK_SPRITES)
		#define YSize (240/__SPRITE_Y_STEP)	
	#elif (defined(__OZ__) && defined(__Z88DK_SPRITES))
		#define YSize (80/__SPRITE_Y_STEP)
	#elif (defined(__C128_Z80__) && defined(__Z88DK_SPRITES))
		#define YSize ((200/__SPRITE_Y_STEP)-Y_OFFSET)
	#elif (defined(__Z88__) && defined(__Z88DK_SPRITES))
	...
	#  if defined(__NCURSES__)
		#define XSize 80
		  ...
		  || (defined(__PX8__) && !defined(__Z88DK_SPRITES)) \
		  || (defined(__APPLE2ENH__) && defined(APPLE2ENH_80COL_VIDEO_MODE)) \
		  || defined(__PPS__) || (defined(__MULTI8__) && !defined(_XL_NO_UDG)) \
		  || (defined(__TS2068__) && !defined(__Z88DK_SPRITES))
		#define XSize 80
	#elif defined(__SRR__) || (defined(__TRS80__) && !defined(__EG2K__) && !defined(__Z88DK_SPRITES))
		#define XSize 64
	#elif defined(__PCE__) || (defined(__PX4__) && defined(Z88DK_PUTC4X6))
		 #define XSize 60
	#elif defined(__TIKI100__)
		#define XSize (1024/__SPRITE_X_STEP)
	#elif ((defined(__NC100__) || defined(__NC200__)) && defined(__Z88DK_SPRITES))
		...
		#define XSize 48
		  ...
		  || (defined(__C128__) && !defined(__Z88DK_SPRITES) && !defined(C128_80COL_VIDEO_MODE)) \
	...
	#elif ((defined(__TI82__) ) && defined(__Z88DK_SPRITES))
		#define XSize ((96/__SPRITE_X_STEP))
	#elif ((defined(__TI83__)) && defined(__Z88DK_SPRITES))
		#define XSize ((96/__SPRITE_X_STEP)+1)
	#elif ((defined(__TI8X__)) && defined(__Z88DK_SPRITES))
		#define XSize ((96/__SPRITE_X_STEP)+1)	
	#elif ((defined(__TI85__) || defined(__TI86__)) && defined(__Z88DK_SPRITES))
		#define XSize (128/__SPRITE_X_STEP)	
	#elif (defined(__TRS80__) && !defined(__EG2K__) && defined(__Z88DK_SPRITES))
		#define XSize (128/__SPRITE_X_STEP)
	#elif (defined(__Z88__) && defined(__Z88DK_SPRITES))
        ...
        #define XSize 16
	#elif (defined(__VZ__) && !defined(__Z88DK_SPRITES)) || defined(__NES__) || defined(__CREATIVISION__) || defined(__MSX__) \

...
#define _TILE_8 (char) (0x7A-0x20-13)



#define _TILE_4 (char) (0x76-0x20-13)
#define _TILE_5 (char) (0x78-0x20-13)
#define _TILE_9 (char) (0x7B-0x20-13)

#define _TILE_0 '\''
#define _TILE_1 ((char) 0x76 - 6 - 0x20-12)
#define _TILE_2 ((char) 0x76 - 2 - 0x20-13)
#define _TILE_3 ((char) 0x76 - 4 -0x20-13)
...
#define _TILE_7 (char) (0x77 - 0x20-13)

...
//(130 + level * 2)
#define POWER_UP2_INITIAL_COOLDOWN 650

#define POWER_UP3_INITIAL_COOLDOWN 1000

#define FREEZE_INITIAL_COOLDOWN 30
//550

#define FROZEN_COUNT_DOWN 100

#define INVINCIBLE_COUNT_DOWN 70

...
#include "cross_lib.h"
	...
	#define BOSS_TILE_1 _TILE_1
    #define BOSS_TILE_2 _TILE_22
	
    #define BOSS_TILE_3 _TILE_3
    #define BOSS_TILE_4 _TILE_21
    
	#define BOSS_TILE_5 _TILE_5
    #define BOSS_TILE_6 _TILE_20
    ...
    #define SECRET_TILE BOSS_TILE_0

...
void draw_screen(void)
{
    ...
    /* Draw maze tiles, offset by DRAW_Y_OFFSET so maze starts at row 2 */
    ...
    /* Draw key only if not yet collected */
    ...
    /* Draw torch only if not yet collected */
    ...
    /* HUD text in rows 0 and 1 (above the maze) */

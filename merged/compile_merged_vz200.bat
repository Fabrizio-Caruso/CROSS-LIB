...
zcc +vz -vn -D__VZ__ -lndos -Cz--audio -create-app -o  %deliverables%\MINIMAL_vz200_experimental %mypath%\display_macros.c %mypath%\enemy.c %mypath%\invincible_enemy.c %mypath%\level.c %mypath%\character.c %mypath%\text.c %mypath%\missile.c %mypath%\strategy.c %mypath%\input_macros.c %mypath%\main.c

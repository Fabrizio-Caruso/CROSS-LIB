...
const uint8_t walls_index[] =
{
	...
	LV_0_WALLS_SIZE+LV_1_WALLS_SIZE+LV_2_WALLS_SIZE+LV_3_WALLS_SIZE+LV_4_WALLS_SIZE+LV_5_WALLS_SIZE+LV_6_WALLS_SIZE+LV_7_WALLS_SIZE+LV_8_WALLS_SIZE, // challenge
